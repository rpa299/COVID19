...
public class BdTablePerfil implements BaseColumns {
    ...
    public static final String[] TODOS_CAMPOS = {CAMPO_ID_COMPLETO, CAMPO_DATA_NASCIMENTO_COMPLETO, CAMPO_SEXO_COMPLETO, CAMPO_ALTURA_COMPLETO, CAMPO_PESO_COMPLETO, CAMPO_TIPO_SANGUE_COMPLETO};
